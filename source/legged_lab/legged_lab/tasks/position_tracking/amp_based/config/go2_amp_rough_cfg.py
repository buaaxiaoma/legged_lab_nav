...
class Go2AmpRoughEnvCfg(LocomotionAmpEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.learned_reward.weight = 1.0
        ...
        self.reward_learning.enabled = True
        self.reward_learning.update_interval = 100
        self.reward_learning.target_terms = []
        self.reward_learning.log_per_term = True

        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "Go2AmpRoughEnvCfg" and not self.reward_learning.enabled:
